...
public class PrintChamberedWoodTemplate extends JComponent implements Printable {
    ...
    public static void printChambering(
            AbstractDraw d,
            double offsetX,
            double offsetY,
            double scale,
            ...
            double deckAndBottomMinimumThickness) {
        if (brd.isEmpty()) {
            return;
        }
    ...
    public static void printAlignmentMarks(
            AbstractDraw d,
            double offsetX,
            double offsetY,
            double scale,
    ...
    public void printTemplate(
            ...
            double endOffsetFromCenter,
            double plankThickness,
            double deckAndBottomMinimumThickness,
            boolean drawChambering,
            boolean drawAlignmentMarks,
            boolean printMultiple) {
    ...
    public void paintComponent(Graphics g) {
        ...
        printChambering(
                ...
                mOffsetFromCenter,
                mPlankThickness,
                mDeckAndBottomMinimumThickness);
        BezierBoardDrawUtil.printProfile(
                jd,
                ...
                false,
                BoardCAD.getInstance().getCurrentBrd(),
                mOffsetFromCenter + mPlankThickness,
                0.0,
                false,
                0.0,
                0.0);
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) {
        ...
        if (printTemplate(pageFormat, pageIndex, g) == 0) return PAGE_EXISTS;
