...
public class PrintSpecSheet extends JComponent implements Printable {
    ...
    public void printSpecSheet() {
        ...
        if (myPageFormat == printJob.defaultPage()) return;
    ...
    public void paintComponent(Graphics g) {
        ...
        // (dim.mImagableWidth-(border*2))/(BoardCAD.getInstance().getCurrentBrd().getLength()), true,
         ...
         * (dim.mImagableWidth-(border*2))/(BoardCAD.getInstance().getCurrentBrd().getLength()),
         * true,BoardCAD.getInstance().getCurrentBrd(),false); BezierBoardDrawUtil.printRailTemplate(jd, border,
         * dim.height*3.0/5.0, (dim.mImagableWidth-(border*2))/(BoardCAD.getInstance().getCurrentBrd().getLength()),
         ...
         * 
         * BezierBoardDrawUtil.paintFunction(jd, border, dim.height/2.0, mScale, new Color(0,0,0), new
         * BasicStroke((float)(2.0/mScale)), func, 0.0, 1.0, 200.0, 10.0);
         */
    }
    ...
    int printSpecSheet(PageFormat pageFormat, int pageIndex, Graphics g) {
        ...
        String measurementsString = LanguageResource.getString("MEASUREMENTS_STR")
                + UnitUtils.convertLengthToCurrentUnit(mBrd.getLength(), true) + LanguageResource.getString("BY_STR")
                + UnitUtils.convertLengthToCurrentUnit(mBrd.getCenterWidth(), true) + LanguageResource.getString("BY_STR")
                + UnitUtils.convertLengthToCurrentUnit(mBrd.getThickness(), true);
         ...
         * tmp.setLine(mBrd.getFins()[0],mBrd.getFins()[1],mBrd.getFins()[2],mBrd.getFins()[3]); g2d.draw(tmp);
         * tmp.setLine(mBrd.getFins()[0],-mBrd.getFins()[1],mBrd.getFins()[2],-mBrd.getFins()[3]); g2d.draw(tmp);
         * tmp.setLine(mBrd.getFins()[5],0,mBrd.getFins()[4],0); g2d.draw(tmp);
         */
        ...
        BezierBoardDrawUtil.paintSlidingCrossSection(
                ...
                false,
                true,
                mBrd.getLength() - UnitUtils.INCHES_PR_FOOT * UnitUtils.INCH,
                mBrd);
            ...
            if (mBrd.getFins()[5] != 0) {
                g.drawString(
                        LanguageResource.getString("CENTERFIN_STR") + LanguageResource.getString("FRONT_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[5], false)
                                + LanguageResource.getString("REAR_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[4], false)
                                + LanguageResource.getString("DEPTH_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[6], false),
                        xm,
                        currentY);
                currentY += hgt + 5;
            }
            ...
            if (mBrd.getFins()[2] != 0) {
                g.drawString(
                        LanguageResource.getString("SIDEFINS_STR") + LanguageResource.getString("FRONT_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[2], false)
                                + LanguageResource.getString("REAR_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[0], false)
                                + LanguageResource.getString("DEPTH_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[7], false)
                                + LanguageResource.getString("TOEIN_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[3] - mBrd.getFins()[1], false)
                                + LanguageResource.getString("SPLAY_STR")
                                + UnitUtils.convertLengthToCurrentUnit(mBrd.getFins()[8], false),
                        xm,
                        currentY);
                currentY += hgt + 5;
            }
    ...
    float printBoardMeasurementsHorizontal(Graphics2D g2d, float currentY) {
        ...
        for (int i = 0; i < (mUseDetailedMeasurements ? 7 : 3); i++) {
            ...
            line.setLine(
                    pos * mScale,
                    currentY + (-currentWidth / 2) * mScale,
                    pos * mScale,
                    currentY + (currentWidth / 2) * mScale);
            g2d.draw(line);
    ...
    float printCrossSections(Graphics2D g2d, float currentY) {
        ...
        BezierBoardDrawUtil.paintSlidingCrossSection(
                jd,
                mImagableX + 5 + ((mImagableWidth / 3) * 1),
                currentY,
                0.0,
                mScale,
                Color.BLACK,
        ...
        BezierBoardDrawUtil.paintSlidingCrossSection(
                jd,
                mImagableX + 5 + ((mImagableWidth / 3) * 2),
                currentY,
                0.0,
                mScale,
                Color.BLACK,
