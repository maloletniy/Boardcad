...
public class DxfExport {
    ...
    static public void writeHeader(PrintStream stream) {
        ...
        /*
         * dxf R14 header version stream.println("HEADER"); stream.println("9"); stream.println("$ACADVER");
         * stream.println("  1"); stream.println("AC1014"); stream.println("0"); stream.println("ENDSEC"); stream.println("0");
         * stream.println("SECTION"); stream.println("2");
         */
    ...
    static public void writePolylineBegin(PrintStream stream, int vertexCount) {
        /*
         * dxf R14 version buggy stream.println("LWPOLYLINE"); stream.println(" 5");
         * stream.println(Integer.toString(q++).toUpperCase()); stream.println(" 100"); stream.println("AcDbEntity");
         * stream.println(" 100"); stream.println("AcDbPolyline"); stream.println(" 90");
         * stream.println(Integer.toString(vertexCount)); stream.println(" 8"); stream.println("0"); //Layer
         * stream.println(" 6"); stream.println("CONTINUOUS"); stream.println(" 62"); stream.println("9"); //Color number
         */
    ...
    static public void writeVertex(PrintStream stream, Point2D.Double point) {
        /*
         * dxf r14 version stream.println("10"); stream.println(Double.toString(point.x*SCALE_DXF_TO_SI)); stream.println("20");
    ...
    static public void writeBezierSpline(PrintStream stream, BezierSpline beziers) {
        for (int i = 0; i < beziers.getNrOfControlPoints() - 1; i++) {
            ...
            stream.println("0");
            /*
             * dxf R14 ?? stream.println("100"); stream.println("AcDbEntity"); stream.println("100");
