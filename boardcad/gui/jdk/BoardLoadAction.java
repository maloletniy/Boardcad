    ...
    public void actionPerformed(ActionEvent event) {
        ...
        FileFilter filter = new FileFilter() {
            ...
            public boolean accept(File f) {
                ...
                if (extension != null && (extension.equals("brd") || extension.equals("s3d") || extension.equals("srf")
                        || extension.equals("cad") || extension.equals("stp") || extension.equals("step"))) {
                    return true;
                }
    ...
    public void load(String filename) {
        ...
        if (ext.compareToIgnoreCase("s3d") == 0) {
            ...
            if (ret == 1) // Show warning dialog
            {
                JOptionPane.showMessageDialog(
                        ...
                        LanguageResource.getString("S3DTHICKNESSCURVENOTSUPPOSTEDMSG_STR"),
                        LanguageResource.getString("S3DTHICKNESSCURVENOTSUPPOSTEDTITLE_STR"),
        ...
        if (ret < 0) {
            JOptionPane.showMessageDialog(
                    BoardCAD.getInstance().getFrame(),
                    errorStr,
                    LanguageResource.getString("READBRDFAILEDTITLE_STR"),
