...
public class WeightCalculatorDialog extends JDialog {
    ...
    void calcStringerVolume() {
        final BezierBoard brd = BoardCAD.getInstance().getCurrentBrd();
        if (brd == null || brd.isEmpty()) return;
    ...
    void calcDeckGlassArea() {
                ...
                MathUtils.FunctionXY deckFunc = new MathUtils.FunctionXY() {
                    ...
                    public Point2D.Double f(double s) {
                        Point3d point = AbstractBezierBoardSurfaceModel
                                ...
                                .getPointAt(brd, x, s, -90.0, 90.0, true);
        ...
        mDeckGlassArea = MathUtils.Integral.getIntegral(
                curveLenghtFunc,
                BezierSpline.ZERO,
                brd.getLength() - BezierSpline.ZERO,
                BezierBoard.AREA_SPLITS) * 2.0;
    ...
    void calcBottomGlassArea() {
            ...
            public double f(final double x) {
                MathUtils.FunctionXY BottomFunc = new MathUtils.FunctionXY() {
                    ...
                    public Point2D.Double f(double s) {
                        Point3d point = AbstractBezierBoardSurfaceModel
                                .getBezierBoardSurfaceModel(BoardCAD.getInstance().getCrossSectionInterpolationType())
                                .getPointAt(brd, x, s, 90.0, 360.0, true);
                        return new Point2D.Double(point.y, point.z);
                    }
                };
        ...
        mBottomGlassArea = MathUtils.Integral.getIntegral(
                curveLenghtFunc,
                BezierSpline.ZERO,
                brd.getLength() - BezierSpline.ZERO,
                BezierBoard.AREA_SPLITS) * 2.0;
    ...
    void calcTotalWeight() {
        mTotalBoardWeight = mStringerWeight + mFoamWeight + mTotalGlassWeight + mResinWeight + mHotcoatWeight
                + mPlugsAndFinsWeight;
    }
