...
public class Machine3DView extends JComponent {
    ...
    public Machine3DView() {
        ...
        final AbstractAction toggleSurfacePaths = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                mDeckSurfacePathsSwitch.setWhichChild(
                        (mDeckSurfacePathsSwitch.getWhichChild() == Switch.CHILD_ALL) ? Switch.CHILD_NONE : Switch.CHILD_ALL);
                mBottomSurfacePathsSwitch.setWhichChild(
                        (mBottomSurfacePathsSwitch.getWhichChild() == Switch.CHILD_ALL) ? Switch.CHILD_NONE : Switch.CHILD_ALL);
            }
        };
        ...
        final AbstractAction toggleNormals = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                mDeckNormalsSwitch.setWhichChild(
                        (mDeckNormalsSwitch.getWhichChild() == Switch.CHILD_ALL) ? Switch.CHILD_NONE : Switch.CHILD_ALL);
                mBottomSurfaceNormalsSwitch.setWhichChild(
                        (mBottomSurfaceNormalsSwitch.getWhichChild() == Switch.CHILD_ALL)
                                ? Switch.CHILD_NONE
                                : Switch.CHILD_ALL);
            }
        };
        ...
        final AbstractAction toggleToolpaths = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                mDeckToolpathsSwitch.setWhichChild(
                        (mDeckToolpathsSwitch.getWhichChild() == Switch.CHILD_ALL) ? Switch.CHILD_NONE : Switch.CHILD_ALL);
                mBottomToolpathsSwitch.setWhichChild(
                        (mBottomToolpathsSwitch.getWhichChild() == Switch.CHILD_ALL) ? Switch.CHILD_NONE : Switch.CHILD_ALL);
            }
        };
        ...
        canvas.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.isMetaDown()) menu.show(canvas, e.getX(), e.getY());
            }
    ...
    private BranchGroup createSceneGraph() {
        ...
        double size = 40.0;
        referencePointArray.setCoordinates(
                mDeckCurrentNormalIndex,
                new Point3d[] {
                        new Point3d(-size, 0.0, 0.0),
                        new Point3d(size, 0.0, 0.0),
                        new Point3d(0.0, -size, 0.0),
                        new Point3d(0.0, size, 0.0),
                        new Point3d(0.0, 0.0, -size),
                        new Point3d(0.0, 0.0, size) });
    ...
    public void addDeckSurfaceLine(Point3d point) {
        ...
        mDeckSurfacePathsArray
                .setStripVertexCounts(new int[] { (mDeckCurrentSurfacePathIndex > 2) ? mDeckCurrentSurfacePathIndex : 2 });
    }
    ...
    public void addBottomSurfaceLine(Point3d point) {
        ...
        mBottomSurfacePathsArray
                .setStripVertexCounts(new int[] { (mBottomCurrentSurfacePathIndex > 2) ? mBottomCurrentSurfacePathIndex : 2 });
    }
    ...
    public void addBottomToolpathLine(Point3d point) {
        ...
        mBottomToolpathsArray
                .setStripVertexCounts(new int[] { (mBottomCurrentToolpathIndex > 2) ? mBottomCurrentToolpathIndex : 2 });
    ...
    public void setCutterOffset(Point3d pos) {
        mToolpathsTransform.setTranslation(
                new Vector3d(
                        pos.x * UnitUtils.MILLIMETER_PR_CENTIMETER,
                        pos.y * UnitUtils.MILLIMETER_PR_CENTIMETER,
                        pos.z * UnitUtils.MILLIMETER_PR_CENTIMETER));
        mToolpathsGroup.setTransform(mToolpathsTransform);
    }
