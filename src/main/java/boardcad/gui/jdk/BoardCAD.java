...
import boardcad.gui.jdk.plugin.AbstractPluginHandler;
...
public class BoardCAD implements Runnable, ActionListener, ItemListener, KeyEventDispatcher {
    ...
    static protected Locale[] mSupportedLanguages = {
            new Locale("en", ""),
            new Locale("fr", ""),
            new Locale("pt", ""),
            new Locale("es", ""),
    ...
    protected BoardCAD() {
        ...
        mColorSettings
                .addColor(SELECTEDTANGENTCOLOR, new Color(0, 0, 0), LanguageResource.getString("SELECTEDTANGENTCOLOR_STR"));
        mColorSettings.addColor(
                SELECTEDCONTROLPOINTCENTERCOLOR,
                new Color(30, 30, 200),
                LanguageResource.getString("SELECTEDCONTROLPOINTCENTERCOLOR_STR"));
        mColorSettings.addColor(
                SELECTEDCONTROLPOINTTANGENT1COLOR,
                new Color(200, 200, 0),
        ...
        mSizeSettings.addDouble(
                SELECTEDCONTROLPOINTOUTLINETHICKNESS,
                1.5,
        ...
        mSizeSettings.addDouble(
                UNSELECTEDCONTROLPOINTOUTLINETHICKNESS,
                0.8,
        ...
        mSizeSettings
                .addDouble(VOLUMEDISTRIBUTIONTHICKNESS, 1.2, LanguageResource.getString("VOLUMEDISTRIBUTIONTHICKNESS_STR"));
        ...
        mMiscSettings.addObject(
                LOOK_AND_FEEL,
                mMiscSettings.new Enumeration(systemLookAndFeelIndex, looks),
                LanguageResource.getString("LOOKANDFEEL_STR"),
                new Settings.SettingChangedCallback() {
                    ...
                    public void onSettingChanged(Object obj) {
                        ...
                        if (mBlockGUI == false) {
                            JOptionPane.showMessageDialog(
                                    ...
                                    String.format(
                                            LanguageResource.getString("LOOKANDFEELCHANGEDMSG_STR"),
        ...
        mMiscSettings.addInteger(
                FRACTIONACCURACY,
                16,
                LanguageResource.getString("FRACTIONACCURACY_STR"),
                new Settings.SettingChangedCallback() {
    ...
    public void getPreferences() {
        ...
        mIsPaintingOriginalBrdMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingOriginalBrdMenuItem", mIsPaintingOriginalBrdMenuItem.isSelected()));
        ...
        mIsPaintingNonActiveCrossSectionsMenuItem.setSelected(
                prefs.getBoolean(
        ...
        mIsPaintingGuidePointsMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingGuidePointsMenuItem", mIsPaintingGuidePointsMenuItem.isSelected()));
        mIsPaintingCurvatureMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingCurvatureMenuItem", mIsPaintingCurvatureMenuItem.isSelected()));
        mIsPaintingVolumeDistributionMenuItem.setSelected(
                prefs.getBoolean("mIsPaintingVolumeDistributionMenuItem", mIsPaintingVolumeDistributionMenuItem.isSelected()));
        mIsPaintingCenterOfMassMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingCenterOfMassMenuItem", mIsPaintingCenterOfMassMenuItem.isSelected()));
        mIsPaintingSlidingInfoMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingSlidingInfoMenuItem", mIsPaintingSlidingInfoMenuItem.isSelected()));
        mIsPaintingSlidingCrossSectionMenuItem.setSelected(
                prefs.getBoolean(
        ...
        mIsPaintingBackgroundImageMenuItem.setSelected(
                prefs.getBoolean("mIsPaintingBackgroundImageMenuItem", mIsPaintingBackgroundImageMenuItem.isSelected()));
        ...
        mIsPaintingCenterLineMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingCenterLineMenuItem", mIsPaintingCenterLineMenuItem.isSelected()));
        mIsPaintingOverCurveMesurementsMenuItem.setSelected(
                prefs.getBoolean(
                        "mIsPaintingoverCurveMesurementsMenuItem",
                        mIsPaintingOverCurveMesurementsMenuItem.isSelected()));
        mIsPaintingMomentOfInertiaMenuItem.setSelected(
                prefs.getBoolean("mIsPaintingMomentOfInertiaMenuItem", mIsPaintingMomentOfInertiaMenuItem.isSelected()));

        mIsPaintingCrossectionsPositionsMenuItem.setSelected(
                prefs.getBoolean(
                        "mIsPaintingCrossectionsPositionsMenuItem",
                        mIsPaintingCrossectionsPositionsMenuItem.isSelected()));

        mIsPaintingFlowlinesMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingFlowlinesMenuItem", mIsPaintingFlowlinesMenuItem.isSelected()));
        ...
        mIsPaintingFootMarksMenuItem
                .setSelected(prefs.getBoolean("mIsPaintingFootMarksMenuItem", mIsPaintingFootMarksMenuItem.isSelected()));
    ...
    public AbstractBezierBoardSurfaceModel.ModelType getCrossSectionInterpolationType() {
        if (mControlPointInterpolationButton == null) return AbstractBezierBoardSurfaceModel.ModelType.SLinearInterpolation;
    ...
    public void updateScreenValues() {
        ...
        mFrame.setTitle(
                appname + " - " + getCurrentBrd().getFilename() + "  " + UnitUtils.convertLengthToCurrentUnit(length, true)
                        + " x " + UnitUtils.convertLengthToCurrentUnit(maxWidth, false));

        mBoardSpec.updateInfo();

        if (mWeightCalculatorDialog.isVisible()) mWeightCalculatorDialog.updateAll();

        if (mGuidePointsDialog.isVisible()) mGuidePointsDialog.update();

    }

    protected void setCurrentUnit(int unitType) {
        UnitUtils.setCurrentUnit(unitType);
        if (mWeightCalculatorDialog != null) mWeightCalculatorDialog.updateAll();
        if (mGuidePointsDialog != null) mGuidePointsDialog.update();
        updateScreenValues();
        onControlPointChanged();
        redraw();
    }
    ...
    private int saveChangedBoard() {
        if (mBoardChanged == true) {
            final Object[] options = {
                    LanguageResource.getString("YESBUTTON_STR"),
                    LanguageResource.getString("NOBUTTON_STR"),
                    LanguageResource.getString("CANCELBUTTON_STR") };
    ...
    private void createAndShowGUI() {
        ...
        loadBrd.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_O, KeyEvent.CTRL_DOWN_MASK));
        ...
        final AbstractAction SaveBrd = new AbstractAction() {
            ...
            static final long serialVersionUID = 1L;
            {
                ...
                this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_R, KeyEvent.CTRL_DOWN_MASK));
            };
        ...
        loadGhost.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_G, KeyEvent.CTRL_DOWN_MASK));
        ...
        final AbstractAction printProfileTemplate = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintSandwichTemplates.printProfileTemplate(
                        sandwichSettings.getMeasurement("SkinThickness"),
                        sandwichSettings.getBoolean("Flatten"),
                        0.0);
                settingsDialog.dispose();
            }
        ...
        final AbstractAction printRailTemplate = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintSandwichTemplates.printRailTemplate(
                        sandwichSettings.getMeasurement("ToRail"),
                        sandwichSettings.getMeasurement("SkinThickness"),
                        sandwichSettings.getMeasurement("TailOffset"),
                        sandwichSettings.getMeasurement("NoseOffset"),
                        sandwichSettings.getBoolean("Flatten"));
                settingsDialog.dispose();
            }
        ...
        final AbstractAction printHWSSTringer = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintHollowWoodTemplates.printStringerTemplate(
                        HWSSettings.getMeasurement("SkinThickness"),
                        HWSSettings.getMeasurement("FrameThickness"),
                        HWSSettings.getMeasurement("Webbing"),
                        HWSSettings.getMeasurement("TailOffset"),
        ...
        final AbstractAction printHWSRibs = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintHollowWoodTemplates.printCrosssectionTemplates(
                        HWSSettings.getMeasurement("DistanceFromRail"),
                        HWSSettings.getMeasurement("SkinThickness"),
                        HWSSettings.getMeasurement("FrameThickness"),
                        HWSSettings.getMeasurement("Webbing"));
                settingsDialog.dispose();
        ...
        final AbstractAction printHWSRail = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintHollowWoodTemplates.printRailTemplate(
                        HWSSettings.getMeasurement("DistanceFromRail"),
                        HWSSettings.getMeasurement("SkinThickness"),
                        HWSSettings.getMeasurement("FrameThickness"),
                        HWSSettings.getMeasurement("Webbing"),
        ...
        final AbstractAction printHWSNosePiece = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintHollowWoodTemplates.printNoseTemplate(
                        HWSSettings.getMeasurement("DistanceFromRail"),
                        HWSSettings.getMeasurement("SkinThickness"),
                        HWSSettings.getMeasurement("FrameThickness"),
                        HWSSettings.getMeasurement("Webbing"),
        ...
        final AbstractAction printHWSTailPiece = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintHollowWoodTemplates.printTailTemplate(
                        HWSSettings.getMeasurement("DistanceFromRail"),
                        HWSSettings.getMeasurement("SkinThickness"),
                        HWSSettings.getMeasurement("FrameThickness"),
                        HWSSettings.getMeasurement("Webbing"),
        ...
        final AbstractAction printHWSDeckTemplate = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintHollowWoodTemplates.printDeckSkinTemplate(
                        HWSSettings.getMeasurement("DistanceFromRail"),
                        HWSSettings.getMeasurement("TailOffset"),
                        HWSSettings.getMeasurement("NoseOffset"));
                settingsDialog.dispose();
        ...
        final AbstractAction printHWSBottomTemplate = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                mPrintHollowWoodTemplates.printBottomSkinTemplate(
                        HWSSettings.getMeasurement("DistanceFromRail"),
                        HWSSettings.getMeasurement("TailOffset"),
                        HWSSettings.getMeasurement("NoseOffset"));
                settingsDialog.dispose();
        ...
        final AbstractAction printChamberedWoodTemplate = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                chamberedWoodSettings.addMeasurement(
                        "Start Offset from center",
                        0.0,
                        LanguageResource.getString("CHAMBEREDWOODOFFSETFROMCENTER_STR"));
                chamberedWoodSettings.addMeasurement(
                        "End Offset from center",
                        mCurrentBrd.getMaxWidth() / 2.0,
                        LanguageResource.getString("CHAMBEREDWOODENDOFFSET_STR"));
                chamberedWoodSettings
                        .addMeasurement("Plank thickness", 2.54, LanguageResource.getString("CHAMBEREDWOODPLANKTHICKNESS_STR"));
                chamberedWoodSettings.addMeasurement(
                        "Deck/Bottom thickness",
                        0.8,
                        LanguageResource.getString("CHAMBEREDWOODDECKANDBOTTOMTHICKNESS_STR"));
                chamberedWoodSettings
                        .addBoolean("Draw chambering", true, LanguageResource.getString("CHAMBEREDDRAWCHAMBERING_STR"));
                chamberedWoodSettings.addBoolean(
                        "Draw alignment marks",
                        true,
                        LanguageResource.getString("CHAMBEREDDRAWALIGNEMNETMARKS_STR"));

                chamberedWoodSettings
                        .addBoolean("Print multiple", false, LanguageResource.getString("CHAMBEREDPRINTMULTIPLETEMPLATES_STR"));
                ...
                mPrintChamberedWoodTemplate.printTemplate(
                        chamberedWoodSettings.getBoolean("Draw grid"),
                        start,
                        end,
                        plankThickness,
                        chamberedWoodSettings.getMeasurement("Deck/Bottom thickness"),
                        chamberedWoodSettings.getBoolean("Draw chambering"),
                        chamberedWoodSettings.getBoolean("Draw alignment marks"),
                        printMultiple);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                FileFilter filter = new FileFilter() {
                    ...
                    public boolean accept(File f) {
                        ...
                        if (extension != null && (extension.equals("png") || extension.equals("gif") || extension.equals("bmp")
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("EXPORTNURBSTOSTEPFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("EXPORTNURBSTODXFFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("EXPORTNURBSTOSTLFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("EXPORTBEZIERFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
        ...
        final AbstractAction exportBezierCrossection = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    if (BrdWriter.exportCrossection(
                            getCurrentBrd(),
                            getCurrentBrd().getCurrentCrossSectionIndex(),
                            filename) == false) {
                        throw new Exception();
                    }
                } catch (Exception e) {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("GCODEOUTLINEFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
        ...
        final AbstractAction gcodeProfile = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                hotwireSettings.addMeasurement("CuttingSpeed", 50.0, LanguageResource.getString("HOTWIRECUTTINGSPEED_STR"));
                hotwireSettings
                        .addMeasurement("AdditionalThickness", 0.0, LanguageResource.getString("ADDITIONALTHICKNESS_STR"));
                SettingDialog settingsDialog = new SettingDialog(settings);
                settingsDialog.setTitle(LanguageResource.getString("HOTWIREPARAMETERSTITLE_STR"));
                settingsDialog.setModal(true);
                settingsDialog.setVisible(true);
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("GCODEPROFILEFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("GCODEDECKFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("GCODEBOTTOMFAILEDMSG_STR"),
                            JOptionPane.ERROR_MESSAGE);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("ATUACORESPROFILEFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            BoardCAD.getInstance().getFrame(),
                            str,
                            LanguageResource.getString("ATUACORESOUTLINEFAILEDTITLE_STR"),
                            JOptionPane.ERROR_MESSAGE);
        ...
        final AbstractAction test = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                /*
                 * CategorizedSettings settings = new CategorizedSettings(); settings.addCategory("test");
                 * settings.getSettings("test").addBoolean("Test1", true, "Test 1");
                 *
                 * SettingDialog dialog = new SettingDialog(settings); dialog.setModal(true); dialog.setVisible(true);
                 * if(!dialog.wasCancelled()) { boolean test1 = settings.getSettings("test").getBoolean("Test1");
                 ...
                 * double startAngle = b.getNormalByS(BezierSpline.ZERO); double endAngle = b.getNormalByS(BezierSpline.ONE);
                 *
                 ...
                 * System.out.printf("----------------------------------------\n");
                 *
                 * for(int i = 0; i < steps; i++) { double currentAngle = b.getNormalByS((double)i/(double)steps);
                 ...
                 * currentAngle = startAngle + (angleStep*i); double s = b.getSByNormalReverse(currentAngle); double checkAngle
                 * = b.getNormalByS(s); System.out.printf("Target Angle:%f Result s:%f Angle for s:%f\n",
        ...
        final AbstractAction addCrossSection = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                String posStr = JOptionPane.showInputDialog(
                        ...
                        LanguageResource.getString("ADDCROSSECTIONTITLE_STR"),
                        JOptionPane.PLAIN_MESSAGE);
        ...
        final AbstractAction moveCrossSection = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                String posStr = JOptionPane.showInputDialog(
                        ...
                        LanguageResource.getString("MOVECROSSECTIONTITLE_STR"),
                        JOptionPane.PLAIN_MESSAGE);
        ...
        final AbstractAction pasteCrossSection = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (mCrossSectionCopy == null) return;
        ...
        final AbstractAction scaleGhost = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                getGhostBrd()
                        .scale(getCurrentBrd().getLength(), getCurrentBrd().getCenterWidth(), getCurrentBrd().getThickness());
        ...
        final AbstractAction flip = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (mOutlineEdit2 != null) mOutlineEdit2.setFlipped(!mOutlineEdit2.isFlipped());
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (!languageDlg.wasCancelled()) {
                    ...
                    JOptionPane.showMessageDialog(
                            ...
                            LanguageResource.getString("LANGUAGECHANGEDTITLE_STR"),
                            JOptionPane.INFORMATION_MESSAGE);
                }
        ...
        final AbstractAction bezier_patch = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (board_handler.approximate_bezier_patch(getCurrentBrd(), false) < 0) JOptionPane.showMessageDialog(
                        BoardCAD.getInstance().getFrame(),
                        "All cross sections must have 4 or 5 control points",
                        "Couldn't create bezier patch",
                        JOptionPane.ERROR_MESSAGE);
        ...
        /*
         * final ButtonGroup burbsViewGroup = new ButtonGroup(); rbMenuItem = new
         * JRadioButtonMenuItem(LanguageResource.getString("VIEW3D_STR")); rbMenuItem.setSelected(true);
         * rbMenuItem.addActionListener(this); menu3D.add(rbMenuItem); burbsViewGroup.add(rbMenuItem); rbMenuItem = new
         * JRadioButtonMenuItem(LanguageResource.getString("EDITNURBS_STR")); rbMenuItem.addActionListener(this);
         * burbsViewGroup.add(rbMenuItem); menu3D.add(rbMenuItem);
         *
         * menu3D.addSeparator();
         */
        ...
        final AbstractAction addsegment = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                String s = (String) JOptionPane.showInputDialog(mFrame, LanguageResource.getString("DISTANCEFROMTAIL_STR"));
        ...
        final AbstractAction taildesigner = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                String s = (String) JOptionPane.showInputDialog(mFrame, LanguageResource.getString("SWALLOWTAIL_STR"));
        ...
        final AbstractAction setnrofsegments = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                String s = (String) JOptionPane.showInputDialog(mFrame, LanguageResource.getString("NROFSEGMENT_STR"));
        ...
        final AbstractAction setnrofpoints = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                String s = (String) JOptionPane.showInputDialog(mFrame, LanguageResource.getString("NROFPOINTS_STR"));
        ...
        /*
         *
         * AbstractAction repair = new AbstractAction() { { this.putValue(Action.NAME,
         * LanguageResource.getString("REPAIR_STR")); // this.putValue(Action.ACCELERATOR_KEY,
         * KeyStroke.getKeyStroke(KeyEvent.VK_PLUS, 0)); };
         *
         * public void actionPerformed(ActionEvent arg0) {
         *
         ...
         */
        /*
         * AbstractAction loadairbrush = new AbstractAction() { { this.putValue(Action.NAME, "Load airbrush"); //
         * this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_PLUS, 0)); };
         *
         * public void actionPerformed(ActionEvent arg0) {
         *
        ...
        /*
         * AbstractAction settolerance = new AbstractAction() { { this.putValue(Action.NAME, "Set tolerance"); //
         * this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_PLUS, 0)); };
         *
         * public void actionPerformed(ActionEvent arg0) { String s=(String)JOptionPane.showInputDialog(mFrame,
         * "Set tolerance (mm)");
         *
         * board_handler.set_tolerance(Double.parseDouble(s)); } }; menu3D.add(settolerance);
         *
         ...
         * "Max iterations");
         *
         * board_handler.set_iterations(Integer.parseInt(s)); } }; menu3D.add(setmaxiterations);
         */
        ...
        final ChangeListener lifeSizeChangeListner = new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                BoardEdit edit = getSelectedEdit();
                if (edit != null) {
                    if (edit.isLifeSize() == isLifeSize) return;

                    edit.setLifeSize(isLifeSize);

                    if (!isLifeSize) edit.resetToPreviousScale();
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                if (selectedControlPoints.size() == 0) {
                    JOptionPane.showMessageDialog(
                            ...
                            LanguageResource.getString("NOCONTROLPOINTSELECTEDTITLE_STR"),
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
                ...
                int selection = JOptionPane.showConfirmDialog(
                        ...
                        LanguageResource.getString("DELETECONTROLPOINTSTITLE_STR"),
                        JOptionPane.WARNING_MESSAGE,
                        JOptionPane.YES_NO_OPTION);
         ...
         * millimeterButton.addActionListener(new ActionListener() { public void actionPerformed(final ActionEvent e) {
         * setCurrentUnit(UnitUtils.MILLIMETERS); } }); final JRadioButton imperialButton = new
         * JRadioButton(LanguageResource.getString("FEETINCHESRADIOBUTTON_STR")); imperialButton.setSelected(true);
         * imperialButton.addActionListener(new ActionListener() { public void actionPerformed(final ActionEvent e) {
         * setCurrentUnit(UnitUtils.INCHES); } }); final JRadioButton imperialDecimalButton = new
         * JRadioButton(LanguageResource.getString("DECIMALFEETINCHESRADIOBUTTON_STR"));
         * imperialDecimalButton.addActionListener(new ActionListener() { public void actionPerformed(final ActionEvent e) {
         * setCurrentUnit(UnitUtils.INCHES_DECIMAL); } }); final JRadioButton centimeterButton = new
         * JRadioButton(LanguageResource.getString("CENTIMETERSRADIOBUTTON_STR")); centimeterButton.addActionListener(new
         * ActionListener() { public void actionPerformed(final ActionEvent e) { setCurrentUnit(UnitUtils.CENTIMETERS); } });
         *
         * final ButtonGroup unitButtonGroup = new ButtonGroup(); unitButtonGroup.add(imperialButton);
         * unitButtonGroup.add(millimeterButton); unitButtonGroup.add(centimeterButton);
         * unitButtonGroup.add(imperialDecimalButton); mToolBar.add(imperialButton); //mToolBar.addSeparator();
         * mToolBar.add(millimeterButton); //mToolBar.addSeparator(); mToolBar.add(centimeterButton); //mToolBar.addSeparator();
         * mToolBar.add(imperialDecimalButton);
         */
        JLabel unitLabel = new JLabel(LanguageResource.getString("UNIT_STR"));
        mToolBar.add(unitLabel);

        String[] unitsStrList = new String[] {
                LanguageResource.getString("FEETINCHESRADIOBUTTON_STR"),
        ...
        view1 = new BoardEdit() {
            ...
            public void drawPart(
                ...
                if (isPaintingCrossectionsPositions()) drawOutlineCrossections(this, g, color, stroke, brd);
                if (isPaintingFlowlines()) drawOutlineFlowlines(this, g, getFlowLinesColor(), stroke, brd);
                if (isPaintingTuckUnderLine()) drawOutlineTuckUnderLine(this, g, getTuckUnderLineColor(), stroke, brd);
            ...
            public void mousePressed(final MouseEvent e) {
                ...
                if (mSelectedControlPoints.size() == 0) {
                    ...
                    if (index != -1
                            && Math.abs(getCurrentBrd().getCrossSections().get(index).getPosition() - brdPos.x) < tolerance) {
                    ...
                    if (getOriginalBrd() != null) {
                        ...
                        if (indexOriginal != -1 && Math.abs(
                                getOriginalBrd().getCrossSections().get(indexOriginal).getPosition() - brdPos.x) < tolerance) {
                            getOriginalBrd().setCurrentCrossSection(indexOriginal);
                        }
                    }
                    if (getGhostBrd() != null) {
                        final int indexGhost = getGhostBrd().getNearestCrossSectionIndex(brdPos.x);
                        if (indexGhost != -1 && Math
                                .abs(getGhostBrd().getCrossSections().get(indexGhost).getPosition() - brdPos.x) < tolerance) {
        ...
        view2 = new BoardEdit() {
            ...
            public BezierSpline[] getActiveBezierSplines(final BezierBoard brd) {
                ...
                if (currentCrossSection == null) return null;
            ...
            public void drawPart(
                ...
                if (isPaintingNonActiveCrossSections()) {
                    ...
                    final BasicStroke stapled = new BasicStroke(
                            (float) (bs.getLineWidth() / 2.0),
                            bs.getEndCap(),
                            bs.getLineJoin(),
                            bs.getMiterLimit(),
                            dashPattern,
                    ...
                    for (int i = 0; i < crossSections.size(); i++) {
                        if (crossSections.get(i) != brd.getCurrentCrossSection()) {
                            ...
                            BezierBoardDrawUtil.paintBezierSpline(
                                    d,
                                    mOffsetX,
                                    mOffsetY - rockerOffset,
                                    mScale,
                                    noneActiveColor,
                                    stapled,
                ...
                if (isPaintingCenterLine()) drawCrossSectionCenterline(this, g, getCenterLineColor(), stroke, brd);
                if (isPaintingTuckUnderLine()) drawCrossSectionTuckUnderLine(this, g, getTuckUnderLineColor(), stroke, brd);
                if (isPaintingFlowlines()) drawCrossSectionFlowlines(this, g, getFlowLinesColor(), stroke, brd);
                if (isPaintingApexline()) drawCrossSectionApexline(this, g, getApexLineColor(), stroke, brd);
            ...
            public void drawBrdCoordinate(Graphics2D g) {
                ...
                String posStr = LanguageResource.getString("CROSSECTIONPOS_STR") + UnitUtils.convertLengthToCurrentUnit(
                        mBoardSpec.isOverCurveSelected() ? brd.getBottom().getLengthByX(crs.getPosition()) : crs.getPosition(),
            ...
            public void drawSlidingInfo(final Graphics2D g, final Color color, final Stroke stroke, final BezierBoard brd) {
                ...
                if (brd.getCrossSections().size() == 0) return;

                this.setName("QuadViewCrossSection");

                if (brd.getCurrentCrossSection() == null) return;
                ...
                if (textX + size.width + 10 > dim.width) textX = dim.width - size.width - 10;
                ...
                final AffineTransform savedTransform = BezierBoardDrawUtil
                        .setTransform(new JavaDraw(g), mOffsetX, mOffsetY, mScale);
            ...
            public void fitBrd() {
                ...
                if (width < brd.getCenterWidth()) width = brd.getCenterWidth();
            ...
            Point2D.Double getNose() {
                ...
                final Point2D.Double nose = (Point2D.Double) getActiveBezierSplines(brd)[0]
                        .getControlPoint(getActiveBezierSplines(brd)[0].getNrOfControlPoints() - 1).getEndPoint().clone();
                nose.y = tail.y;
            ...
            public void repaint() {
                super.repaint();
                if (mCrossSectionOutlineEdit != null) mCrossSectionOutlineEdit.repaint();
            }
        ...
        view3 = new BoardEdit() {
            ...
            public void drawPart(
                ...
                if (isPaintingBaseLine()) {
                    drawStringer(
                            g,
                            mColorSettings.getColor(BASELINECOLOR),
                            new BasicStroke((float) (mSizeSettings.getDouble(BASELINETHICKNESS) / mScale)),
                            brd);
                }
                if (isPaintingFlowlines()) drawProfileFlowlines(this, g, getFlowLinesColor(), stroke, brd);
                if (isPaintingApexline()) drawProfileApexline(this, g, getApexLineColor(), stroke, brd);
                if (isPaintingTuckUnderLine()) drawProfileTuckUnderLine(this, g, getTuckUnderLineColor(), stroke, brd);
                if (isPaintingFootMarks() && (brd == getCurrentBrd() || (brd == getGhostBrd() && isGhostMode())
                        || (brd == getOriginalBrd() && isOrgFocus())))
                ...
                BezierBoardDrawUtil.paintBezierSplines(
                        ...
                        color,
                        stroke,
                        new BezierSpline[] { brd.getBottom(), brd.getDeck() },
                        mDrawControl,
                        fill);
            ...
            public void mousePressed(final MouseEvent e) {
                ...
                if (mSelectedControlPoints.size() == 0) {
                    ...
                    if (getOriginalBrd() != null) {
                        final int indexOriginal = getOriginalBrd().getNearestCrossSectionIndex(brdPos.x);
                        if (indexOriginal != -1 && Math
                                .abs(getOriginalBrd().getCrossSections().get(index).getPosition() - brdPos.x) < tolerance) {
                            getOriginalBrd().setCurrentCrossSection(indexOriginal);
                        }
                    }
                    if (getGhostBrd() != null) {
                        ...
                        if (indexOriginal != -1
                                && Math.abs(getGhostBrd().getCrossSections().get(index).getPosition() - brdPos.x) < tolerance) {
        ...
        /*
         * mOutlineAndProfileSplitPane = new BrdEditSplitPane( JSplitPane.VERTICAL_SPLIT, mOutlineEdit2, mBottomAndDeckEdit);
         * mOutlineAndProfileSplitPane.setOneTouchExpandable(true); mOutlineAndProfileSplitPane.setResizeWeight(0.7);
         *
        ...
        mCrossSectionOutlineEdit = new BoardEdit() {
            ...
            public void drawPart(
                ...
                if (isPaintingFlowlines()) BezierBoardDrawUtil.paintOutlineFlowLines(
                        new JavaDraw(g),
                        mOffsetX,
                        mOffsetY,
                        mScale,
                ...
                if (isPaintingTuckUnderLine()) BezierBoardDrawUtil.paintOutlineTuckUnderLine(
                        new JavaDraw(g),
                        mOffsetX,
                        mOffsetY,
                        mScale,
                        getTuckUnderLineColor(),
                        stroke,
                        brd,
                        (mDrawControl & BezierBoardDrawUtil.FlipX) != 0,
                        true);
                ...
                BezierBoardDrawUtil.paintBezierSplines(
                        new JavaDraw(g),
                        mOffsetX,
                        mOffsetY + ((brd.getCenterWidth() / 2.0 + brd.getMaxRocker()) * mScale),
                        mScale,
                        current,
                        stroke,
                        new BezierSpline[] { brd.getDeck(), brd.getBottom() },
                        (mDrawControl & BezierBoardDrawUtil.FlipX) | BezierBoardDrawUtil.FlipY,
                        fill);

                if (isPaintingFlowlines()) BezierBoardDrawUtil.paintProfileFlowLines(
                        new JavaDraw(g),
                        mOffsetX,
                        mOffsetY + (((brd.getCenterWidth() / 2 + brd.getMaxRocker())) * mScale),
                        mScale,
                        getFlowLinesColor(),
                        stroke,
                        brd,
                ...
                if (isPaintingApexline()) BezierBoardDrawUtil.paintProfileApexline(
                        new JavaDraw(g),
                        mOffsetX,
                        mOffsetY + (((brd.getCenterWidth() / 2 + brd.getMaxRocker())) * mScale),
                        mScale,
                ...
                if (isPaintingTuckUnderLine()) BezierBoardDrawUtil.paintProfileTuckUnderLine(
                        new JavaDraw(g),
                        mOffsetX,
                        mOffsetY + (((brd.getCenterWidth() / 2 + brd.getMaxRocker())) * mScale),
                        mScale,
                ...
                if (BoardCAD.getInstance().isGhostMode() && ghost != null && !ghost.isEmpty()) {
                    ...
                    BezierBoardDrawUtil.paintBezierSplines(
                            ...
                            brdColor,
                            stroke,
                            new BezierSpline[] { ghost.getDeck(), ghost.getBottom() },
                            (mDrawControl & BezierBoardDrawUtil.FlipX) | BezierBoardDrawUtil.FlipY,
                            fill);
                ...
                if (BoardCAD.getInstance().isOrgFocus() && org != null && !org.isEmpty()) {
                    ...
                    BezierBoardDrawUtil.paintBezierSplines(
                            ...
                            brdColor,
                            stroke,
                            new BezierSpline[] { org.getDeck(), org.getBottom() },
                            (mDrawControl & BezierBoardDrawUtil.FlipX) | BezierBoardDrawUtil.FlipY,
                            fill);
        ...
        mTabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(final ChangeEvent e) {
                ...
                /*
                 * if (mTabbedPane.getSelectedComponent() == mNurbspanel) { if (mNeverApproximateNurbs == true) return;
                 *
                 * if (mAlwaysApproximateNurbs == false) {
                 *
                 * final Object[] options = { "Always", "Yes", "No", "Never" }; final int n =
                 * JOptionPane.showOptionDialog(mFrame, "Approximate Nurbs/3D from beziers?", "Nurbs/3D",
                 * JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[1]);
                 *
                 * switch (n) { case 0: mAlwaysApproximateNurbs = true; break; case 1: break; case 3: mNeverApproximateNurbs =
                 * true; case 2: return; // break out
                 *
                 * } } board_handler.approximate_bezier(getCurrentBrd(), false); design_panel.update_3d(); //
                 * design_panel.fit_all(); design_panel.redraw();
                 *
                 * }
                 */
            }
        ...
        // DEBUG
        /*
         * mIsPaintingGridMenuItem.setSelected(false); mIsPaintingOriginalBrdMenuItem.setSelected(false);
         * mIsPaintingGhostBrdMenuItem.setSelected(false); mIsPaintingControlPointsMenuItem.setSelected(true);
         * mIsPaintingNonActiveCrossSectionsMenuItem.setSelected(false); mIsPaintingGuidePointsMenuItem.setSelected(false);
         * mIsPaintingCurvatureMenuItem.setSelected(false); mIsPaintingSlidingInfoMenuItem.setSelected(true);
         * mIsPaintingSlidingCrossSectionMenuItem.setSelected(false); mIsPaintingFinsMenuItem.setSelected(false);
         * mIsPaintingBackgroundImageMenuItem.setSelected(true); mIsAntialiasingMenuItem.setSelected(false);
         * BrdReader.loadFile(getCurrentBrd(), DefaultBrds.getInstance().getBoardArray("Funboard"), "funboard");
         * mOriginalBrd.set(getCurrentBrd()); fitAll(); onBrdChanged();
         *
         * getSelectedEdit().loadBackgroundImage("F:\\Gfx\\Misc\\Surfboards\\horan 6'8 keelboard outline.jpg");
         */
    ...
    public void actionPerformed(final ActionEvent e) {
        ...
        if (cmdStr == LanguageResource.getString("PRINTOUTLINE_STR")) {
            ...
            mPrintBrd.printSpinTemplate(
                    printOutlineSettings.getBoolean("PrintGrid"),
    ...
    public boolean dispatchKeyEvent(final KeyEvent e) {
        if (mControlPointInfo != null && mControlPointInfo.isEditing()) return false;

        if (mGuidePointsDialog != null && mGuidePointsDialog.isVisible() && mGuidePointsDialog.isFocused()) return false;
        ...
        if (this.getFrame().getFocusOwner() == null) return false;
        ...
        if (isGhostMode()) {
            if (e.getID() == KeyEvent.KEY_PRESSED) {
                switch (e.getKeyCode()) {
                case KeyEvent.VK_UP:
                    if (edit != null) edit.mGhostOffsetY -= (e.isAltDown() ? .1f : 1f) / edit.getScale();
                    mFrame.repaint();
                    return true;
                ...
                case KeyEvent.VK_LEFT:
                    if (edit != null) edit.mGhostOffsetX -= (e.isAltDown() ? .1f : 1f) / edit.getScale();
                    mFrame.repaint();
                    return true;
        ...
        if (mOrgFocus) {
            if (e.getID() == KeyEvent.KEY_PRESSED) {
                ...
                switch (e.getKeyCode()) {
                case KeyEvent.VK_UP:
                    if (edit != null) edit.mOriginalOffsetY -= (e.isAltDown() ? .1f : 1f) / edit.getScale();
                    mFrame.repaint();
                    return true;
                case KeyEvent.VK_DOWN:
                    if (edit != null) edit.mOriginalOffsetY += (e.isAltDown() ? .1f : 1f) / edit.getScale();
                    ...
                    return true;
                case KeyEvent.VK_LEFT:
                    if (edit != null) edit.mOriginalOffsetX -= (e.isAltDown() ? .1f : 1f) / edit.getScale();
                    mFrame.repaint();
                    return true;
                case KeyEvent.VK_RIGHT:
                    if (edit != null) edit.mOriginalOffsetX += (e.isAltDown() ? .1f : 1f) / edit.getScale();
    ...
    public void drawOutlineFootMarks(final BoardEdit source, final Graphics2D g, final Stroke stroke, final BezierBoard brd) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            if (i < 3) {
                ...
                label = "W.P:" + UnitUtils.convertLengthToCurrentUnit(
                        mBoardSpec.isOverCurveSelected()
        ...
        for (int i = 0; i < 7; i++) {
            ...
            if (i < 3) {
                ...
                label = "Center: " + UnitUtils.convertLengthToCurrentUnit(
                        mBoardSpec.isOverCurveSelected() ? brd.getBottom().getPointByCurveLength(pos).x : pos,
                        false);
            } else {
                pos = (mBoardSpec.isOverCurveSelected() ? brd.getBottom().getLength() : brd.getLength())
                ...
                label = (i == 6)
                        ? ""
                        : UnitUtils.convertLengthToCurrentUnit(-(6 - i) * UnitUtils.INCH * UnitUtils.INCHES_PR_FOOT, false);
            }

            if (mBoardSpec.isOverCurveSelected()) {
                pos = brd.getBottom().getPointByCurveLength(pos).x;

                if (label != "") label = label.concat(" O.C");
            }
    ...
    public void drawOutlineSlidingInfo(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
            final BezierBoard brd) {
        ...
        if (BoardCAD.getInstance().isPaintingMomentOfInertia()) {
            ...
            g.drawString(
                    source.mSlidingInfoString,
                    textX,
                    dim.height - (size.height + 2) * (BoardCAD.getInstance().isPaintingOverCurveMeasurements() ? 5 : 2));
        }
        ...
        final AffineTransform savedTransform = BezierBoardDrawUtil
                .setTransform(new JavaDraw(g), source.mOffsetX, source.mOffsetY, source.mScale);

        source.mSlidingInfoLine
                .setLine(source.mBrdCoord.x * mulX, -(width / 2) * mulY, source.mBrdCoord.x * mulX, (width / 2) * mulY);
    ...
    public void drawOutlineCrossections(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
    ...
    public void drawProfileSlidingInfo(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
        ...
        source.mSlidingInfoLine
                .setLine(source.mBrdCoord.x * mulX, rocker * mulY, source.mBrdCoord.x * mulX, (rocker + thickness) * mulY);
    ...
    public void drawProfileCrossections(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
    ...
    public void drawOutlineFlowlines(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
            final BezierBoard brd) {
        BezierBoardDrawUtil.paintOutlineFlowLines(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY,
                source.mScale,
                ...
                stroke,
                brd,
                (source.mDrawControl & BezierBoardDrawUtil.FlipX) != 0,
                true);
    }

    public void drawOutlineTuckUnderLine(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
            final BezierBoard brd) {
        BezierBoardDrawUtil.paintOutlineTuckUnderLine(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY,
                source.mScale,
    ...
    public void drawProfileFlowlines(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
            final BezierBoard brd) {
        BezierBoardDrawUtil.paintProfileFlowLines(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY,
                source.mScale,
    ...
    public void drawProfileApexline(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
            final BezierBoard brd) {
        BezierBoardDrawUtil.paintProfileApexline(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY,
                source.mScale,
    ...
    public void drawProfileTuckUnderLine(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
            final BezierBoard brd) {
        BezierBoardDrawUtil.paintProfileTuckUnderLine(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY,
                source.mScale,
    ...
    public void drawCrossSectionCenterline(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
        ...
        BezierBoardDrawUtil.paintCrossSectionCenterline(
                new JavaDraw(g),
                source.mOffsetX,
    ...
    public void drawCrossSectionFlowlines(
            ...
            final BezierBoard brd) {
        boolean isCompensatedForRocker = BoardCAD.getInstance().isUsingOffsetInterpolation();
        BezierBoardDrawUtil.paintCrossSectionFlowLines(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY + (isCompensatedForRocker
                        ? brd.getRockerAtPos(brd.getCurrentCrossSection().getPosition()) * source.mScale
    ...
    public void drawCrossSectionApexline(
            final BoardEdit source,
            final Graphics2D g,
            final Color color,
            final Stroke stroke,
            final BezierBoard brd) {
        boolean isCompensatedForRocker = BoardCAD.getInstance().isUsingOffsetInterpolation();
        BezierBoardDrawUtil.paintCrossSectionApexline(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY + (isCompensatedForRocker
                        ? brd.getRockerAtPos(brd.getCurrentCrossSection().getPosition()) * source.mScale
    ...
    public void drawCrossSectionTuckUnderLine(
            ...
            final BezierBoard brd) {
        boolean isCompensatedForRocker = BoardCAD.getInstance().isUsingOffsetInterpolation();
        BezierBoardDrawUtil.paintCrossSectionTuckUnderLine(
                new JavaDraw(g),
                source.mOffsetX,
                source.mOffsetY + (isCompensatedForRocker
                        ? brd.getRockerAtPos(brd.getCurrentCrossSection().getPosition()) * source.mScale
    ...
    protected void updateBezier3DModel() {
        if (getCurrentBrd().isEmpty()) return;
