...
public class ControlPointInfo extends JPanel {
    ...
    private void initialize() {
        ...
        this.setBorder(
                BorderFactory.createTitledBorder(
                        ...
                        LanguageResource.getString("CONTROLPOINTINFOTITLE_STR"),
                        TitledBorder.LEFT,
        ...
        if (mContinous == null) {
            ...
            mContinous.addItemListener(new java.awt.event.ItemListener() {
                ...
                public void itemStateChanged(java.awt.event.ItemEvent e) {
                    if (mBlockActions) return;

                    ((BrdEditCommand) BoardCAD.getInstance().getCurrentCommand()).setContinous(
                            BoardCAD.getInstance().getSelectedEdit(),
        ...
        if (SetButton == null) {
            ...
            SetButton.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    ((BrdEditCommand) BoardCAD.getInstance().getCurrentCommand())
                            .setControlPoint(BoardCAD.getInstance().getSelectedEdit(), getValues());
                }
            });
        }
        return SetButton;
    ...
    public Point2D.Double getValues() {
        ...
        point.setLocation(
                UnitUtils.convertInputStringToInternalLengthUnit(svx),
                UnitUtils.convertInputStringToInternalLengthUnit(svy));

        return point;
    }

    boolean isEditing() {
        return (getMEndPointX().hasFocus() || getMEndPointY().hasFocus() || getMTangent1X().hasFocus()
                || getMTangent1Y().hasFocus() || getMTangent2X().hasFocus() || getMTangent2Y().hasFocus());
    }
    ...
    private JButton getSetControlPointVerticalButton() {
        if (setControlPointVerticalButton == null) {
            ...
            setControlPointVerticalButton.addActionListener(new java.awt.event.ActionListener() {
    ...
    private JButton getSetControlPointHorizontalButton() {
        if (setControlPointHorizontalButton == null) {
            ...
            setControlPointHorizontalButton.addActionListener(new java.awt.event.ActionListener() {
