...
public class BoardSpec extends JPanel {
    ...
    void updateMeasurements() {
        ...
        if (!board_handler.is_empty()) {
            Length.setText(
                    LanguageResource.getString("STRAIGHTLINE_STR") + " "
                            + UnitUtils.convertLengthToCurrentUnit(board_handler.get_board_length() / 10, true));
        ...
        LengthOverCurve.setText(
                LanguageResource.getString("OVERCURVE_STR") + " "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getLengthOverCurve(), true));
        ...
        centerWidth.setText(
                centerWidth.getText().substring(0, centerWidth.getText().indexOf(":") + 1) + "     "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getWidthAt(centerPos), false));
        Widepoint.setText(
                Widepoint.getText().substring(0, Widepoint.getText().indexOf(":") + 1) + "      "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getMaxWidth(), false) + " @ "
                        + UnitUtils.convertLengthToCurrentUnit(widepointPos, false));
        Thickpoint.setText(
                Thickpoint.getText().substring(0, Thickpoint.getText().indexOf(":") + 1) + "      "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getMaxThickness(), false) + " @ "
                        + UnitUtils.convertLengthToCurrentUnit(thickpointPos, false));
        WidthAtNose.setText(
                WidthAtNose.getText().substring(0, WidthAtNose.getText().indexOf(":") + 1) + "  "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getWidthAtPos(oneFootFromNosePos), false));
        WidthAtTail.setText(
                WidthAtTail.getText().substring(0, WidthAtTail.getText().indexOf(":") + 1) + "     "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getWidthAtPos(oneFootFromTailPos), false));
        ThicknessAtCenter.setText(
                ThicknessAtCenter.getText().substring(0, ThicknessAtCenter.getText().indexOf(":") + 1) + "     "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getThicknessAtPos(centerPos), false));
        ThicknessAtNose.setText(
                ThicknessAtNose.getText().substring(0, ThicknessAtNose.getText().indexOf(":") + 1) + "  "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getThicknessAtPos(oneFootFromNosePos), false));
        ThicknessAtTail.setText(
                ThicknessAtTail.getText().substring(0, ThicknessAtTail.getText().indexOf(":") + 1) + "     "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getThicknessAtPos(oneFootFromTailPos), false));
        RockerAtNose.setText(
                RockerAtNose.getText().substring(0, RockerAtNose.getText().indexOf(":") + 1) + "       "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getRockerAtPos(nosePos), false));
        RockerAtTail.setText(
                RockerAtTail.getText().substring(0, RockerAtTail.getText().indexOf(":") + 1) + "       "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getRockerAtPos(tailPos), false));
        RockerAtNose1.setText(
                RockerAtNose1.getText().substring(0, RockerAtNose1.getText().indexOf(":") + 1) + "  "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getRockerAtPos(oneFootFromNosePos), false));
        RockerAtNose2.setText(
                RockerAtNose2.getText().substring(0, RockerAtNose2.getText().indexOf(":") + 1) + "  "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getRockerAtPos(twoFeetFromNosePos), false));
        RockerAtTail1.setText(
                RockerAtTail1.getText().substring(0, RockerAtTail1.getText().indexOf(":") + 1) + "  "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getRockerAtPos(oneFootFromTailPos), false));
        RockerAtTail2.setText(
                RockerAtTail2.getText().substring(0, RockerAtTail2.getText().indexOf(":") + 1) + "  "
                        + UnitUtils.convertLengthToCurrentUnit(brd.getRockerAtPos(twoFeetFromTailPos), false));
    ...
    void updateAreaAndVolume() {
        ...
        Area.setText(
                Area.getText().substring(0, Area.getText().indexOf(":") + 1) + " "
                        + UnitUtils.convertAreaToCurrentUnit(brd.getArea()));
        Volume.setText(
                Volume.getText().substring(0, Volume.getText().indexOf(":") + 1) + " "
                        + UnitUtils.convertVolumeToCurrentUnit(brd.getVolume()));
    }
