...
public class BoardFinsDialog extends JDialog {
    ...
    private void initialize() {
        ...
        // x, y for back of fin, x,y for front of fin, back of center, front of center, depth of center, depth of sidefin, splay
        // angle
    ...
    private JButton getOkButton() {
        if (OkButton == null) {
            ...
            OkButton.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    // x, y for back of fin, x,y for front of fin, back of center, front of center, depth of center, depth of
                    // sidefin, splay angle
                    double[] fins = mBrd.getFins();
