...
public class SandwichCompensation {
    ...
    public SandwichCompensation(MachineConfig config) {
        ...
        final Settings sandwichCompensationSettings = mConfig
                .addCategory(LanguageResource.getString("SANDWICHCOMPENSATIONCATEGORY_STR"));
        ...
        sandwichCompensationSettings.addBoolean(
                SANDWICH_DECK_COMPENSATION_ON,
                false,
                LanguageResource.getString("SANDWICH_DECK_COMPENSATION_ENABLED_STR"),
                deckOnCb);
        ...
        sandwichCompensationSettings.addMeasurement(
                SANDWICH_DECK_THICKNESS,
                new Double(0.3),
                LanguageResource.getString("SANDWICH_DECK_COMPENSATION_STR"),
                deckThicknessCb);
        ...
        sandwichCompensationSettings.addMeasurement(
                SANDWICH_DECK_RAIL_LIMIT,
                new Double(0.0),
                LanguageResource.getString("SANDWICH_DECK_RAIL_LIMIT_STR"),
                deckRailLimitCb);
        ...
        sandwichCompensationSettings.addBoolean(
                SANDWICH_BOTTOM_COMPENSATION_ON,
                false,
                LanguageResource.getString("SANDWICH_BOTTOM_COMPENSATION_ENABLED_STR"),
                bottomOnCb);
        ...
        sandwichCompensationSettings.addMeasurement(
                SANDWICH_BOTTOM_THICKNESS,
                new Double(0.3),
                LanguageResource.getString("SANDWICH_BOTTOM_COMPENSATION_STR"),
                bottomThicknessCb);
        ...
        sandwichCompensationSettings.addMeasurement(
                SANDWICH_BOTTOM_RAIL_LIMIT,
                new Double(0.0),
                LanguageResource.getString("SANDWICH_BOTTOM_RAIL_LIMIT_STR"),
                bottomRailLimitCb);
        ...
        SettingChangedCallback outlineOnCb = new Settings.SettingChangedCallback() {
            ...
            public void onSettingChanged(Object object) {
                ...
                sandwichCompensationSettings.getSetting(SANDWICH_OUTLINE_COMPENSATION)
                        .setDisabled(!mUseSandwichOutlineCompensation);
            }
        };
        sandwichCompensationSettings.addBoolean(
                SANDWICH_OUTLINE_COMPENSATION_ON,
                false,
                LanguageResource.getString("SANDWICH_OUTLINE_COMPENSATION_ENABLED_STR"),
                outlineOnCb);
        ...
        sandwichCompensationSettings.addMeasurement(
                SANDWICH_OUTLINE_COMPENSATION,
                new Double(0.3),
                LanguageResource.getString("SANDWICH_OUTLINE_COMPENSATION_STR"),
                outlineCb);
    }
