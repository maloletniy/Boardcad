...
import board.readers.S3dReader;
import board.readers.SrfReader;
...
import boardcam.cutters.RotatingBoardCutter;
...
import boardcam.holdingsystems.EndClampsBlankHoldingSystem;
import boardcam.holdingsystems.RotatingBoardBlankHoldingSystem;
import boardcam.holdingsystems.SupportsBlankHoldingSystem;
import boardcam.toolpathgenerators.AbstractToolpathGenerator;
import boardcam.toolpathgenerators.SurfaceSplitsToolpathGenerator;
...
public class MachineConfig extends CategorizedSettings {
    ...
    public void initialize() {
        ...
        generalSettings.addObject(
                USE_BRD_SETTINGS,
                new Boolean(true),
                LanguageResource.getString("USEBRDSETTINGS_STR"),
        ...
        generalSettings
                .addEnumeration(CUTTER_TYPE, 0, cutterTypes, LanguageResource.getString("CUTTERTYPE_STR"), onCutterTypeChanged);
        ...
        generalSettings.addEnumeration(
                BLANKHOLDINGSYSTEM_TYPE,
                0,
                holdingSystemTypes,
                LanguageResource.getString("BLANKHOLDINGSYSTEMTYPE_STR"),
                onBlankHoldingSystemChanged);
        ...
        /*
         * Example of an action inside settings generalSettings.addAction(SAVE_G_CODE, "...", "Save g-code", new
         * Settings.SettingChangedCallback() { public void onSettingChanged(Object obj) { final JFileChooser fc = new
         * JFileChooser();
         * 
         * fc.setCurrentDirectory(new File(BoardCAD.defaultDirectory));
         * 
         * int returnVal = fc.showSaveDialog(BoardCAD.getInstance() .getFrame()); if (returnVal != JFileChooser.APPROVE_OPTION)
         * return;
         * 
         * File file = fc.getSelectedFile();
         * 
         * String filename = file.getPath(); // Load and display // selection if (filename == null) return;
         * 
         * BoardCAD.defaultDirectory = file.getPath();
         * 
         * SurfaceSplitsToolpathGenerator toolpathGenerator = new SurfaceSplitsToolpathGenerator(new BullnoseCutter(),
         * BoardCAD.getInstance().getCurrentMachineConfig());
         * 
         * try { toolpathGenerator.writeDeck(filename, BoardCAD.getInstance().getCurrentBrd()); } catch (Exception e) { String
         * str = "Failed to write g-code file :" + e.toString(); JOptionPane.showMessageDialog(BoardCAD.getInstance()
         * .getFrame(), str, "Error when writing g-code file", JOptionPane.ERROR_MESSAGE);
         * 
         * } } } );
         */
        ...
        cutsSettings
                .addObject(STAY_AWAY_FROM_STRINGER, new Boolean(true), LanguageResource.getString("STAYAWAYFROMSTRINGER_STR"));
        cutsSettings.addObject(
                STRINGER_WIDTH,
                generalSettings.new Measurement(0.5),
                LanguageResource.getString("STRINGERWIDTH_STR"));
        ...
        cutsSettings.addEnumeration(
                DECK_OUTLINE_CUT_DEPTH,
                0,
                outlineDepthTypes,
                LanguageResource.getString("DECKOUTLINECUTDEPTH_STR"));
        ...
        speedSettings
                .addObject(CUTTING_SPEED_STRINGER, new Double(254), LanguageResource.getString("STRINGERCUTTINGSPEED_STR"));
        ...
        controlSettings.addEnumeration(
                BEFORE_DECK_CUT,
                1,
                homeingTypes,
                LanguageResource.getString("BEFOREDECKCUT_STR"),
                new Settings.SettingChangedCallback() {
                    ...
                    public void onSettingChanged(Object obj) {
                        ...
                        case 4:
                            controlSettings.addFileName(
                                    BEFORE_DECK_CUT_SCRIPT,
                                    "",
                                    LanguageResource.getString("BEFOREDECKCUTSCRIPT_STR"));
                            break;
                        }
        ...
        controlSettings.addEnumeration(
                ...
                1,
                homeingTypes,
                LanguageResource.getString("AFTERDECKCUT_STR"),
                new Settings.SettingChangedCallback() {
                    ...
                    public void onSettingChanged(Object obj) {
                        ...
                        case 4:
                            controlSettings.addFileName(
                                    AFTER_DECK_CUT_SCRIPT,
                                    "",
                                    LanguageResource.getString("AFTERDECKCUTSCRIPT_STR"));
                            break;
                        }
                        updateClearHeightSetting();
                    }
        ...
        controlSettings.addEnumeration(
                ...
                1,
                homeingTypes,
                LanguageResource.getString("BEFOREBOTTOMCUT_STR"),
                new Settings.SettingChangedCallback() {
                    ...
                    public void onSettingChanged(Object obj) {
                        ...
                        case 4:
                            controlSettings.addFileName(
                                    BEFORE_BOTTOM_CUT_SCRIPT,
                                    "",
                                    LanguageResource.getString("BEFOREBOTTOMCUTSCRIPT_STR"));
                            break;
                        }
                        updateClearHeightSetting();
                    }
        ...
        controlSettings
                .addEnumeration(BOTTOM_START_POS, 0, startOnBottomTypes, LanguageResource.getString("BOTTOMSTARTPOS_STR"));

        controlSettings.addEnumeration(
                AFTER_BOTTOM_CUT,
                1,
                homeingTypes,
                LanguageResource.getString("AFTERBOTTOMCUT_STR"),
                new Settings.SettingChangedCallback() {
                    ...
                    public void onSettingChanged(Object obj) {
                        ...
                        case 4:
                            controlSettings.addFileName(
                                    AFTER_BOTTOM_CUT_SCRIPT,
                                    "",
                                    LanguageResource.getString("AFTERBOTTOMCUTSCRIPT_STR"));
                            break;
                        }
                        updateClearHeightSetting();
                    }
        ...
        Settings.SettingChangedCallback onCutterOffsetChanged = new Settings.SettingChangedCallback() {
            ...
            public void onSettingChanged(Object obj) {
                ...
                mCutterOffset = new Point3d(
                        cutterOffsetSettings.getMeasurement(CUTTER_X_OFFSET),
                        cutterOffsetSettings.getMeasurement(CUTTER_Y_OFFSET),
                        cutterOffsetSettings.getMeasurement(CUTTER_Z_OFFSET));
        ...
        cutterOffsetSettings
                .addMeasurement(CUTTER_X_OFFSET, 0.0, LanguageResource.getString("CUTTER_X_OFFSET_STR"), onCutterOffsetChanged);
        cutterOffsetSettings
                .addMeasurement(CUTTER_Y_OFFSET, 0.0, LanguageResource.getString("CUTTER_Y_OFFSET_STR"), onCutterOffsetChanged);
        cutterOffsetSettings
                .addMeasurement(CUTTER_Z_OFFSET, 0.0, LanguageResource.getString("CUTTER_Z_OFFSET_STR"), onCutterOffsetChanged);
        ...
        // Read cutter and blank holding system settings here so we don't overwrite with default values when getting the full
        // set of settings result in changed of cutter or holding system
