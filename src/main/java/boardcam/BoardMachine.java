...
/**
 * Machine interface for cutting boards (nurbs surfaces) Works for 3 and 4 axis machines Requires the file shapebot.properties
 * to be located in BoardCAD's home dir Also requires an stl-model of the cutter to be located in the same dir
 */
...
public class BoardMachine {
    ...
    /*
     * public BoardMachine() { bottom_cut=new NurbsPoint[100000]; bottom_collision=new boolean[100000]; deck_cut=new
     * NurbsPoint[100000]; deck_collision=new boolean[100000]; nr_of_cuts_bottom=0; nr_of_cuts_deck=0; deckFileName=new
     * String("deck.ngc"); bottomFileName=new String("bottom.ngc");
     * 
     * read_machine_data(); }
     */
    ...
    public static void read_machine_data() {
        ...
        try {
            ...
            setting = "End support";
            double[] t = {
                    Double.parseDouble(properties.getProperty("machine.supportEndX")),
            ...
            double[][] m = {
                    getAxisArray(properties.getProperty("machine.axisForBoardcadX")),
            ...
            support1 = new NurbsPoint(
                    Double.parseDouble(properties.getProperty("machine.support1.distance")),
            ...
            support2 = new NurbsPoint(
                    Double.parseDouble(properties.getProperty("machine.support2.distance")),
            ...
            setting = "scanner";
            scan_coord = new NurbsPoint(
                    Double.parseDouble(properties.getProperty("scanner.supportEndX")),
            ...
            axis4_offset = new NurbsPoint(
                    Double.parseDouble(properties.getProperty("machine.offsetX")),
            ...
            System.out.println(
                    new StringBuilder("shapebot.properties error at parameter ").append(setting)
                            .append(": ")
                            .append(e)
                            .toString());
        }
