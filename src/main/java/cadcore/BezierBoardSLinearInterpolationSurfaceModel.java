...
class BezierBoardSLinearInterpolationSurfaceModel extends AbstractBezierBoardSurfaceModel {
    ...
    synchronized public Point3d getPointAt(
        ...
        // System.out.printf("targetWidth: %f targetThickness: %f c1SplineWidth x2: %f c2SplineWidth x2: %f c1SplineThick: %f
        // c2SplineThick: %f\n", targetWidth, targetThickness, c1SplineWidth*2.0, c2SplineWidth*2.0, c1SplineThick,
        // c2SplineThick);
    ...
    synchronized public Vector3d getNormalAt(
        ...
        // System.out.printf("BezierBoardSLinearInterpolationSurfaceModel.getNormalAt() second point x:%f, result: %f, %f,
