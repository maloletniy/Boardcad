...
public class BrdReader {
    ...
    static public int loadEncryptedFile(BezierBoard brd, String aFilename, String key) {
        ...
        try {
            ...
            PBEParameterSpec pbeParamSpec = new PBEParameterSpec(new byte[] { -57, 115, 33, -116, 126, -56, -18, -103 }, 20);
    ...
    static void readArrayOfControlPointsAndGuidepoints(
            BufferedReader cFile,
            BezierSpline spline,
            ArrayList<Point2D.Double> guidepointArray) {
        try {
            if (spline != null) {
                String strLine = cFile.readLine();
                        ...
                        while (strLine.startsWith("(gp")) {
                            ...
                            guidepointArray.add(
                                    new Point2D.Double(
                                            ...
                                            Double.valueOf(values[1]).doubleValue()));
    ...
    static BezierKnot readControlPoint(String string) {
        ...
        if (string.startsWith("(cp") == false) return null;
