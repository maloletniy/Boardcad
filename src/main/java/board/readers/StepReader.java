...
public class StepReader {
        ...
        do {
            try {
                ...
                if (pos >= 0) {
                    ...
                    if (pos >= 0) is_boardcad_file = true;

                    pos = cartpoint.indexOf("BCstep 1.0");
                    if (pos >= 0) file_version = 1.0;
                }
                ...
                if (cartesian_points[i] != null) {
                    if (cartesian_points[i].name.equalsIgnoreCase("outline guide point")) {
                        brd.getOutlineGuidePoints()
                                .add(new Point2D.Double(cartesian_points[i].x / 10, cartesian_points[i].z / 10));
                    }
                }
            ...
            for (i = 0; i < 10000; i++) {
                if (cartesian_points[i] != null) {
                    if (cartesian_points[i].name.equalsIgnoreCase("bottom guide point")) {
                        brd.getBottomGuidePoints()
                                .add(new Point2D.Double(cartesian_points[i].x / 10, cartesian_points[i].y / 10));
                    }
                }
                ...
                for (j = 0; j < 10000; j++) {
                    if (cartesian_points[j] != null) {
                        if (cartesian_points[j].name.equalsIgnoreCase("cross section " + i + " guide point")) {
                            brd.getCrossSections().get(i).getGuidePoints().add(
                                    new Point2D.Double(cartesian_points[j].z / 10, cartesian_points[j].y / 10));
                        }
                    }
                }
    ...
    /**
     * Adds meta data for the bezier control points This is a hack where the name of the cartesian point is used to store
     * information about tangent continuity between bezier segments. Not sure if there is a better way to store this information
     * in the step file
     * 
