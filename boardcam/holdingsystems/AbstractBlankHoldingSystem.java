...
public class AbstractBlankHoldingSystem {
    ...
    public String toString(boolean isDeckCut) {
        ...
        String boardOffsetStr = String.format(
                "Board offset: %f,%f,%f Angle:%f\n",
                boardOffset.x,
                boardOffset.y,
                boardOffset.z,
                isDeckCut ? mBoardDeckRotation : mBoardBottomRotation);
        Vector3d blankOffset = isDeckCut ? mBlankDeckOffset : mBlankBottomOffset;
        String blankOffsetStr = String.format(
                "Blank offset: %f,%f,%f Angle:%f\n",
                blankOffset.x,
                blankOffset.y,
                blankOffset.z,
                isDeckCut ? mBlankDeckRotation : mBlankBottomRotation);
