...
public class BrdWriter {
    ...
    static public boolean saveFile(BezierBoard brd, String aFilename) {
        try {
            ...
            // Write in same sequence as original .brd file(not that I believe it matters, but to make sure the files are
            // identical)
    ...
    static public boolean exportCrossection(BezierBoard brd, int index, String aFilename) {
        try {
            ...
            write(
                    writer,
                    "(p36 " + Double.valueOf(current.getPosition()) + "\n",
                    current.getBezierSpline(),
                    current.getGuidePoints());
    ...
    static void buildId(int id) {
        resetBuilder();
        builder.append("p");
        if (id < 10) builder.append("0");
        builder.append(Integer.valueOf(id));
        builder.append(" : ");

    }

    static void write(FileWriter writer, int id, String value) throws IOException {
        if (value == null || value.length() == 0) return; // This seem to be the behaviour of aps3000/akushaper
    ...
    static void write(FileWriter writer, int id, int value) throws IOException {
        buildId(id);
    ...
    static void write(FileWriter writer, int id, double value) throws IOException {
        buildId(id);
    ...
    static void write(FileWriter writer, int id, float value) throws IOException {
        buildId(id);
    ...
    static void write(FileWriter writer, int id, boolean value) throws IOException {
        buildId(id);
    ...
    static void write(FileWriter writer, int id, double[] values) throws IOException {
        buildId(id);
    ...
    static void write(FileWriter writer, BezierKnot knot) throws IOException {
    ...
    static void write(FileWriter writer, Point2D.Double guidepoint) throws IOException {
        resetBuilder();
        builder.append("(gp [");
    ...
    static void write(FileWriter writer, int id, ArrayList<BezierBoardCrossSection> crossSectionArray) throws IOException {
        buildId(id);
