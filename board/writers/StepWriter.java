...
public class StepWriter {
    ...
    static public void saveFile(PrintStream dataOut, String filename, NurbsBoard board, BezierBoard brd) {
        ...
        dataOut.println(
                "FILE_NAME ('" + filename + "','" + now.get(Calendar.YEAR) + "-" + now.get(Calendar.MONTH) + "-"
                        + now.get(Calendar.DAY_OF_MONTH) + "T" + now.get(Calendar.HOUR_OF_DAY) + ":" + now.get(Calendar.MINUTE)
                        + ":" + now.get(Calendar.SECOND) + "',( '' ),( '' ),'BCstep 1.0','BoardCAD','');");
        ...
        for (int i = 2; i < deck.get_nr_of_segments() - 2; i++) {
            for (int j = 2; j < deck.get_nr_of_points() - 2; j++) {
                ...
                dataOut.println(
                        "#" + k + " = CARTESIAN_POINT ( 'NONE',  ( " + Double.toString(value.x) + ", "
                                + Double.toString(value.y) + ", " + Double.toString(value.z) + ") );");
                k = k + 1;
            }
        }
        ...
        dataOut.println(
                "#" + k + " = CARTESIAN_TRANSFORMATION_OPERATOR( '','','',#" + (k + 1) + ", #" + (k + 2) + ", #" + (k + 3)
                        + ",1.0);");
        k++;
        dataOut.println(
                "#" + k + " = DIRECTION ( 'x axis',  ( " + Double.toString(x_axis_direction.x) + ", "
                        + Double.toString(x_axis_direction.y) + ", " + Double.toString(x_axis_direction.z) + ") );");
        k++;
        dataOut.println(
                "#" + k + " = DIRECTION ( 'y axis',  ( " + Double.toString(y_axis_direction.x) + ", "
                        + Double.toString(y_axis_direction.y) + ", " + Double.toString(y_axis_direction.z) + ") );");
        k++;
        dataOut.println(
                "#" + k + " = CARTESIAN_POINT ( 'local origin',  ( " + Double.toString(local_origin.x) + ", "
                        + Double.toString(local_origin.y) + ", " + Double.toString(local_origin.z) + ") );");
        k++;
        ...
        for (int i = 0; i < outline.getNrOfControlPoints(); i++) {
            ...
            if (i > 0) {
                k = k + 1;
                dataOut.println(
                        "#" + k + " = CARTESIAN_POINT ( 'NONE',  ( " + Double.toString(10 * knot.getPoints()[1].x) + ", "
                                + Double.toString(0.0) + ", " + Double.toString(10 * knot.getPoints()[1].y) + ") );");
            }

            k = k + 1;
            dataOut.println(
                    "#" + k + " = CARTESIAN_POINT ( '" + knot.isContinous() + " " + knot.getOther() + "',  ( "
                            + Double.toString(10 * knot.getPoints()[0].x) + ", " + Double.toString(0.0) + ", "
                            + Double.toString(10 * knot.getPoints()[0].y) + ") );");

            k = k + 1;
            if (i < outline.getNrOfControlPoints() - 1) {
                dataOut.println(
                        "#" + k + " = CARTESIAN_POINT ( 'NONE',  ( " + Double.toString(10 * knot.getPoints()[2].x) + ", "
                                + Double.toString(0.0) + ", " + Double.toString(10 * knot.getPoints()[2].y) + ") );");
            }
        }
        ...
        for (int i = 0; i < brd.getOutlineGuidePoints().size(); i++) {
            k = k + 1;
            dataOut.println(
                    "#" + k + " = CARTESIAN_POINT ( 'outline guide point',  ( "
                            + Double.toString(10 * brd.getOutlineGuidePoints().get(i).x) + ", " + Double.toString(0.0) + ", "
                            + Double.toString(10 * brd.getOutlineGuidePoints().get(i).y) + ") );");
        }
        ...
        for (int i = 0; i < bottom2.getNrOfControlPoints(); i++) {
            ...
            if (i > 0) {
                ...
                dataOut.println(
                        "#" + k + " = CARTESIAN_POINT ( 'NONE',  ( " + Double.toString(10 * knot.getPoints()[1].x) + ", "
                                + Double.toString(10 * knot.getPoints()[1].y) + ", " + Double.toString(0.0) + ") );");
            }

            k = k + 1;
            dataOut.println(
                    "#" + k + " = CARTESIAN_POINT ( '" + knot.isContinous() + " " + knot.getOther() + "',  ( "
                            + Double.toString(10 * knot.getPoints()[0].x) + ", " + Double.toString(10 * knot.getPoints()[0].y)
                            + ", " + Double.toString(0.0) + ") );");
            ...
            if (i < bottom2.getNrOfControlPoints() - 1) {
                dataOut.println(
                        "#" + k + " = CARTESIAN_POINT ( 'NONE',  ( " + Double.toString(10 * knot.getPoints()[2].x) + ", "
                                + Double.toString(10 * knot.getPoints()[2].y) + ", " + Double.toString(0.0) + ") );");
            }
        }
        ...
        for (int i = 0; i < brd.getBottomGuidePoints().size(); i++) {
            k = k + 1;
            dataOut.println(
                    "#" + k + " = CARTESIAN_POINT ( 'bottom guide point',  ( "
                            + Double.toString(10 * brd.getBottomGuidePoints().get(i).x) + ", "
                            + Double.toString(10 * brd.getBottomGuidePoints().get(i).y) + ", " + Double.toString(0.0) + ") );");
        }
        ...
        for (int i = 0; i < brd.getDeckGuidePoints().size(); i++) {
            k = k + 1;
            dataOut.println(
                    "#" + k + " = CARTESIAN_POINT ( 'deck guide point',  ( "
                            + Double.toString(10 * brd.getDeckGuidePoints().get(i).x) + ", "
                            + Double.toString(10 * brd.getDeckGuidePoints().get(i).y) + ", " + Double.toString(0.0) + ") );");
        }
        ...
        for (int n = 0; n < crossSectionArray.size(); n++) {
            ...
            for (int i = 0; i < section.getNrOfControlPoints(); i++) {
                ...
                if (i > 0) {
                    k = k + 1;
                    dataOut.println(
                            "#" + k + " = CARTESIAN_POINT ( 'NONE',  ( " + Double.valueOf(10 * current.getPosition()) + ", "
                                    + Double.toString(10 * knot.getPoints()[1].y) + ", "
                                    + Double.toString(10 * knot.getPoints()[1].x) + ") );");
                }

                k = k + 1;
                dataOut.println(
                        "#" + k + " = CARTESIAN_POINT ( '" + knot.isContinous() + " " + knot.getOther() + "',  ( "
                                + Double.valueOf(10 * current.getPosition()) + ", "
                                + Double.toString(10 * knot.getPoints()[0].y) + ", "
                                + Double.toString(10 * knot.getPoints()[0].x) + ") );");

                k = k + 1;
                if (i < section.getNrOfControlPoints() - 1) {
                    dataOut.println(
                            "#" + k + " = CARTESIAN_POINT ( 'NONE',  ( " + Double.valueOf(10 * current.getPosition()) + ", "
                                    + Double.toString(10 * knot.getPoints()[2].y) + ", "
                                    + Double.toString(10 * knot.getPoints()[2].x) + ") );");
                }
            }
            ...
            for (int i = 0; i < brd.getCrossSections().get(n).getGuidePoints().size(); i++) {
                k = k + 1;
                dataOut.println(
                        "#" + k + " = CARTESIAN_POINT ( 'cross section " + n + " guide point',  ( " + Double.toString(0.0)
                                + ", " + Double.toString(10 * brd.getCrossSections().get(n).getGuidePoints().get(i).y) + ", "
                                + Double.toString(10 * brd.getCrossSections().get(n).getGuidePoints().get(i).x) + ") );");
            }
        ...
        k++;
        dataOut.println(
                "#" + k + "=MECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION('',(#" + (k - 1) + "),#" + (k + 2) + ");");
        k++;
        dataOut.println("#" + k + "=ADVANCED_BREP_SHAPE_REPRESENTATION('ABSR',(#" + brep + "),#" + (k + 1) + ");");
        k++;

        dataOut.println(
                "#" + k + " = ( GEOMETRIC_REPRESENTATION_CONTEXT(3)GLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT((#" + (k + 4)
                        + ")) GLOBAL_UNIT_ASSIGNED_CONTEXT((#" + (k + 1) + ",#" + (k + 2) + ",#" + (k + 3)
        ...
        k++;
        dataOut.println(
                "#" + k + " = UNCERTAINTY_MEASURE_WITH_UNIT(LENGTH_MEASURE(0.01),#" + (k - 3)
