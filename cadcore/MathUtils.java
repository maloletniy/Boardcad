    ...
    public static class RootFinder {
        ...
        static public double getRoot(Function function, double targetValue, double minLimit, double maxLimit) {
            ...
            if (Math.abs(function.f(x) - targetValue) > ROOTFINER_VALUE_TOLERANCE) {
                ...
                // function.f(x), targetValue, function.f(x)-targetValue);
        ...
        public static class SecantRootFinder {
            ...
            static public double getRoot(Function function, double target_value, double minLimit, double maxLimit) {
                ...
                if (last_x > maxLimit) last_x = x - (maxLimit - minLimit) / 10.0;
                ...
                // System.out.printf("SecantRootFinder.getRoot(): START current_error:%f, x:%f last_value:%f current_value:%f
                // target_value:%f\n", current_error, x, last_value, current_value, target_value);

                int n = 0;
                while (Math.abs(current_error) > ROOTFINER_VALUE_TOLERANCE && n++ < SECANT_MAX_ITERATIONS
                    ...
                    // System.out.printf("SecantRootFinder.getRoot(): d:%f, current_error:%f, x:%f last_value:%f
                    // current_value:%f target_value:%f\n", d, current_error, x, last_value, current_value, target_value);
        ...
        public static class BisectRootFinder {
            ...
            static public double getRoot(Function function, double target_value, double minLimit, double maxLimit) {
                ...
                while (Math.abs(current_error) > ROOTFINER_VALUE_TOLERANCE && n++ < BISECT_MAX_ITERATIONS && ht - lt > 0.0001) {
                    ...
                    if (current_error * l_error < 0.0) // if these two positions have the opposite sign, then the root must be
                                                       // within the this span
                    {
                    ...
                    // System.out.printf("BisectRootFinder.getRoot(): current_error:%f, x:%f lt:%f ht:%f current_value:%f
